    ...
    public static contacts = [
        {
            ...
            'fullName': 'Abbott Keitch',
            'preferredName': 'Royalguard',
            'title': 'Digital Archivist',
            'email'   : 'abbott@withinpixels.com',
            'mobileNumber'   : '+1-202-555-0175',
            'createdOn' : '2020-03-01'
        },
        {
            'id'      : '5725a680606588342058356d',
            'fullName'    : 'Arnold Matlock',
            'preferredName': 'Wanderer',
            'title': 'Graphic Artist',
            'email'   : 'arnold@withinpixels.com',
            'mobileNumber'   : '+1-202-555-0141',
            'createdOn' : '2020-03-01',
            'modifiedOn': '2020-03-10'
        },
        {
            'id'      : '5725a68009e20d0a9e9acf2a',
            'fullName'    : 'Barrera Bradbury',
            'preferredName': 'Jackal',
            'title': 'Graphic Designer',
            'email'   : 'barrera@withinpixels.com',
            'mobileNumber'   : '+1-202-555-0196',
            'createdOn' : '2020-03-01',
            'modifiedOn': '2020-03-10'
        },
        {
            'id'      : '5725a6809fdd915739187ed5',
            'fullName'    : 'Blair Strangeway',
            'preferredName': 'Knight',
            'title': 'Visual Designer',
            'email'   : 'blair@withinpixels.com',
            'mobileNumber'   : '+1-202-555-0118',
            'createdOn' : '2020-03-01',
            'modifiedOn': '2020-03-10'
        },
        {
            'id'      : '5725a68007920cf75051da64',
            'fullName'    : 'Boyle Winters',
            'preferredName': 'Jester',
            'title': 'Catalogue Illustrator',
            'email'   : 'boyle@withinpixels.com',
            'mobileNumber'   : '+1-202-555-0177',
            'createdOn' : '2020-03-01'
        }
    ];
